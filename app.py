            ...
            try: 
                ...
                if values[0] != 0:  
                    ...
                    with col1:        
                        ...
                        st.markdown(f"  🧮 **Mean Daily Points (x 1.30):** {round(Open_mean_daily,0)} XP")
                        st.markdown(f"&nbsp;∑ **Estimated Total Points in TGE:** {round(Open_points_tge,0)} XP")
                    ...
                    with col2: 
                        ...
                        st.markdown(f"  🧮 **Mean Daily Points (x 1.30):** {round(Level_mean_daily,0)} XP")
                        st.markdown(f"&nbsp;∑ **Estimated Total Points in TGE:** {round(Level_points_tge,0)} XP")
                    ...
                    with col3: 
                        ...
                        st.markdown(f"  🧮 **Mean Daily Points (x 1.30):** {round(Frag_mean_daily,0)} XP")
                        st.markdown(f"&nbsp;∑ **Estimated Total Points in TGE:** {round(Frag_points_tge,0)} XP")
                    ...
                    with col4: 
                        ...
                        st.markdown(f"  🧮 **Mean Daily Points (x 1.30):** {round(Ky_mean_daily,0)} XP")
                        st.markdown(f"&nbsp;∑ **Estimated Total Points in TGE:** {round(Ky_points_tge,0)} XP")
